        ...
        <div className="container flex justify-between">
                  ...
                  dark:bg-gray-900 p-2 dark:text-white">
                    <ul className="space-y-2">
                      {DropdownLinks.map((data) => (
                        <li key={data.id}>
                          <a
                          className="text-gray-500 w-full  dark:hover:text-white duration-200 p-2 inline-block hover:bg-primary/20 rounded-md font-semibold"
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="relative group hidden sm:block ">
              ...
              <IoMdSearch
                className="text-xl text-gray-600 group-hover:text-primary dark:text-gray-400 absolute top-1/2 -translate-y-1/2
